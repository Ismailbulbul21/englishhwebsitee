...
export default function FoundationSection({ playAudio }) {
  ...
  const alphabetData = [
    ...
    { letter: 'G', example: 'Good', somali: 'Fiican', image: 'https://images.unsplash.com/photo-1580893211123-627e0262be3a?w=300&h=300&fit=crop&crop=center', emoji: '👍' },
    ...
    { letter: 'I', example: 'Ice', somali: 'Baraf', image: 'https://images.unsplash.com/photo-1590430752967-d0e116909be1?w=300&h=300&fit=crop&crop=center', emoji: '🧊' },
    { letter: 'J', example: 'Jump', somali: 'Bood', image: 'https://images.unsplash.com/photo-1531879251-3da65dd78c99?w=300&h=300&fit=crop&crop=center', emoji: '🏃' },
    ...
    { letter: 'O', example: 'Open', somali: 'Fur', image: 'https://images.unsplash.com/photo-1702227962626-788c96edc190?w=300&h=300&fit=crop&crop=center', emoji: '🚪' },
    ...
    { letter: 'Q', example: 'Question', somali: 'Su\'aal', image: 'https://images.unsplash.com/photo-1633613286848-e6f43bbafb8d?w=300&h=300&fit=crop&crop=center', emoji: '❓' },
    ...
    { letter: 'X', example: 'X-ray', somali: 'Raajo', image: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=300&h=300&fit=crop&crop=center', emoji: '🩻' },
    { letter: 'Y', example: 'Yes', somali: 'Haa', image: 'https://images.unsplash.com/photo-1560174971-443de64be852?w=300&h=300&fit=crop&crop=center', emoji: '✅' },
    { letter: 'Z', example: 'Zero', somali: 'Eber', image: 'https://images.unsplash.com/photo-1520413766594-6e635f8d9908?w=300&h=300&fit=crop&crop=center', emoji: '0️⃣' }
  ]
